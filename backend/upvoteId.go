...
func UpRankingSeries(w http.ResponseWriter, r *http.Request) {
	...
	//Realizo la actualización del ranking, disminuyendo su valor en 1Realizo la actualización del ranking, aumentando su valor en 1
        result := db.Exec(
